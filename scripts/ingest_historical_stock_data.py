...
class StockExtractor:
    ...
    def validate_year_to_date_history(self, symbol: str, start_date: str, end_date: str, raw_data: dict) -> List[DailyStockData]:
    ...
    def upload_year_to_date_history_to_s3(self, records: List[DailyStockData], s3_bucket: str | None = None) -> None:
        ...
        file_key = f"raw/stocks/{records[0].symbol}/{current_year}_full_historical.parquet"
...
if __name__ == "__main__":
    ...
    for ticker in tickers:
        try:
            ...
            extractor.upload_year_to_date_history_to_s3(records=validated_records, 
                                                        s3_bucket=S3_BUCKET_DESTINATION)
